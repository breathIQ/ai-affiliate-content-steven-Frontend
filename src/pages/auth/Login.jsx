...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      window.location.href = res?.data.data?.role_id == 2 ? "/u/dashboard" : "/";
    } catch (error) {
      setISloading(false);
              ...
              {!isadmin && (
                <>
                  <button className="w-full border rounded-lg py-2 mb-3 flex items-center justify-center gap-2 text-sm hover:bg-gray-50">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/a/a5/Instagram_icon.png" className="w-4" alt="insta" />
